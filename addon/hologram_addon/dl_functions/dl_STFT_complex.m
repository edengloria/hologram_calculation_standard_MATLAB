function [out_r,out_i] = dl_STFT_complex(in_r, in_i)
...
%% 메인 계산
[dlstft_rr, dlstft_ri] = dlstft(dlarray(in_r), 'Window',hann(array_size,'periodic'),'OverlapLength',0,'FFTLength',array_size,'DataFormat','CTB');
[dlstft_ir, dlstft_ii] = dlstft(dlarray(in_i), 'Window',hann(array_size,'periodic'),'OverlapLength',0,'FFTLength',array_size,'DataFormat','CTB');
