...
r = 2./(1+exp(abs(temp-0.25)/0.02))'+2./(1+exp(abs(temp-0.75)/0.02))';
g = 2./(1+exp(abs(temp-0.25)/0.02))'+2./(1+exp(abs(temp-0.75)/0.02))';
b = 2./(1+exp(abs(temp-0.25)/0.02))'+2./(1+exp(abs(temp-0.75)/0.02))';
h = [r g b];
