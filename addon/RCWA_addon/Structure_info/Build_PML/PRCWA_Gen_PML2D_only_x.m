function [Epsr_PML Apsr_PML] = PRCWA_Gen_PML2D_only_x(pml_width,pml_N,n_surr,Nx,Ny,gambda_x,gambda_y)
...
%             Apsr_PML(mm,nn) = 1/epra*rect_2D(m,n,1,gambda_x,gambda_y,-pml_wx,+pml_wx,-pml_wy,+pml_wy);
             Epsr_PML(mm,nn) =   epra*rect_2D(m,n,1,gambda_x,gambda_y,-pml_wx,+pml_wx,-gambda_y/2,gambda_y/2);
            Apsr_PML(mm,nn) = 1/epra*rect_2D(m,n,1,gambda_x,gambda_y,-pml_wx,+pml_wx,-gambda_y/2,gambda_y/2);         
    end % for nn
end % for mm
...
%                 -rect_2D(m,n,1,gambda_x,gambda_y,-pml1_wx,+pml1_wx,-pml1_wy,+pml1_wy);
            t =  rect_2D(m,n,1,gambda_x,gambda_y,-pml2_wx,+pml2_wx,-gambda_y/2,+gambda_y/2) ...
                -rect_2D(m,n,1,gambda_x,gambda_y,-pml1_wx,+pml1_wx,-gambda_y/2,+gambda_y/2);
