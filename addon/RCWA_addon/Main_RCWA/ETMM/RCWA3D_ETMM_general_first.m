function [F,G,Wtemp,Vtemp,B,invA_X] = RCWA3D_ETMM_general_first(W__, Q__, V__,depth,width_type,Total_layer_num,L,k0,Kx,Ky,dc_profile);  
...
%     Wtemp = eye(size(W__(:,:,1)));
%     [KI Kz] = get_KI_from_Kx_Ky_n0(Kx,Ky,real(sqrt(dc_profile(cnt))),k0,L,NBx,NBy);
%     Vtemp = KI/k0/j;
    Qtemp   = j*[Kz;Kz];
